...
import { userSettingsMessages } from './translations/userSettingTranslations';
// pluginのi18nリソースのインポート
// import { japaneseMyPluginMessages } from './components/translations/myPluginTranslations';
...
const app = createApp({
  ...
  __experimentalTranslations: {
    ...
    // pluginのi18nリソースを使用する際は以下を適用
    // resources: [userSettingsMessages, japaneseMyPluginMessages],
  },
});
